...
| `@lunora/platform-rivet`      | **Experimental.** Rivet **host** over Rivet Actors (`rivetkit`): native sharded state, alarms, hibernated sockets, runtime crons; local SQL via a snapshotted working copy. No dev/deploy target yet.                     |
