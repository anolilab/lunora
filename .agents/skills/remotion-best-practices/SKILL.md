...
For specific caption workflows, load the matching rule:

- Displaying captions (TikTok-style pages, word highlighting): [./rules/display-captions.md](./rules/display-captions.md)
- Importing `.srt` subtitle files with `@remotion/captions`: [./rules/import-srt-captions.md](./rules/import-srt-captions.md)
- Transcribing audio to generate captions: [./rules/transcribe-captions.md](./rules/transcribe-captions.md)
