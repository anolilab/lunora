...
exposes directly — see [Offline-first](/docs/concepts/offline-first) for the
...
Each collection chooses _when_ it starts syncing — together with `scopeBy` this
...
— point a collection at a [shape](/docs/packages/server#defineshapedefinition--partial-replication)
