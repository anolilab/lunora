...
const createCountingBackend = (initial: string[]) => {
    ...
    type EvaluateResult =
        | { continueCursor: null | string; isDone: boolean; page: string[]; splitCursor: null | string }
        | { continueCursor: null | string; isDone: boolean; page: string[] };

    /** @returns pagination result for the given opts */
    const evaluate = (opts: PaginationOpts): EvaluateResult => {
