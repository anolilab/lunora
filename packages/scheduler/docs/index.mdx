...
const scheduler = createScheduler({
    ...
    originUrl: "https://app.acme.test", // required by the type; the DO dispatches from env.LUNORA_ORIGIN_URL
});
...
const pool = createWorkpool({
    ...
    originUrl: "https://app.acme.test", // as above: the DO dispatches from env.LUNORA_ORIGIN_URL
    maxConcurrency: 5,
    name: "stripe-sync",
});
