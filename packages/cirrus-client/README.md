...
No workspace deps beyond its own internals — `@cirrus/client` is the lowest-level user-facing entry point. Framework adapters layer on top: see [`@cirrus/react`](../cirrus-react).
