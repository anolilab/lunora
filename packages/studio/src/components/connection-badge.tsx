...
/**
 * Dot colour per connection status. Semantic status tokens encode the value
 * (good / caution / idle / bad) so the dot reads correctly in both modes; the
 * label below carries the same information for non-colour cues.
 */
const STATUS_DOT = {
