...
const PerformanceBadge = ({ level }: { level: PerformanceLevel }): ReactElement => {
    ...
    if (level === "warning") {
        return (
            <span className="inline-flex items-center gap-1 rounded-md border border-transparent bg-amber-100 px-2 py-0.5 text-xs font-medium text-amber-700 dark:bg-amber-900/30 dark:text-amber-400">
                Moderate
            </span>
        );
    }
    ...
    return (
        <span className="inline-flex items-center gap-1 rounded-md border border-transparent bg-green-100 px-2 py-0.5 text-xs font-medium text-green-700 dark:bg-green-900/30 dark:text-green-400">
            Fast
        </span>
    );
};
        ...
        <div className="space-y-4" data-testid="qi-root">
            ...
            <div className="grid gap-4 md:grid-cols-3">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-amber-600 dark:text-amber-400" data-testid="qi-moderate">
                            {moderate}
                        </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-green-600 dark:text-green-400" data-testid="qi-fast">
                            {fast}
                        </div>
                            ...
                            return (
                                <div className="overflow-hidden rounded-lg border" data-testid="qi-row" key={key}>
                                    <button
                                        ...
                                        // eslint-disable-next-line react-perf/jsx-no-new-function-as-prop -- per-row handler closes over the statement key; admin dev-tool render path
                                        onClick={() => {
                                            toggleExpand(key);
                                        }}
                                        type="button"
