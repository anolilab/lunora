        ...
        <div className="flex flex-col gap-4" data-testid="auth-config">
            <Card className="gap-0 py-0">
                <header className="border-b border-border px-4 py-3">
                    <span className="font-mono text-[11px] tracking-wide text-muted-foreground uppercase">{t("Enabled capabilities")}</span>
                </header>
                            ...
                            {CAPABILITY_ROWS.map((row) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <Badge variant={enabled ? "success" : "outline"}>{enabled ? t("Enabled") : t("Disabled")}</Badge>
                                    </li>
                                );
                            })}
                        </ul>
