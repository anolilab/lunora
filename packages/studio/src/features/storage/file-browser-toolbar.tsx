...
const FileBrowserToolbar = ({
    ...
    const onPrefixInput = (event: ChangeEvent<HTMLInputElement>): void => {
        onPrefixChange(event.target.value);
    };

    const onBucketSelect = (event: ChangeEvent<HTMLSelectElement>): void => {
        onBucketChange(event.target.value);
    };

    const onExpirySelect = (event: ChangeEvent<HTMLSelectElement>): void => {
...
const FileBrowserControls = ({
    ...
    const onSortSelect = (event: ChangeEvent<HTMLSelectElement>): void => {
        onSortKeyChange(event.target.value);
    };

    const onThumbInput = (event: ChangeEvent<HTMLInputElement>): void => {
