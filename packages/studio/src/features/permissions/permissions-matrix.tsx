...
export const PermissionsMatrix = ({ onProbe }: PermissionsMatrixProps = {}): ReactElement => {
    ...
    const rows = useMemo<TableRowState[]>(
        () => (policies === null ? [] : buildRows(policies, maskColumns, uncoveredTables(advisories))),
        [policies, maskColumns, advisories],
    );
                                                ...
                                                <span className="flex flex-col gap-1">
                                                    ...
                                                    {onProbe !== undefined && (
                                                        <Button
                                                            ...
                                                            // eslint-disable-next-line react-perf/jsx-no-new-function-as-prop -- per-cell handler closes over the cell's table/op; admin dev-tool render path
                                                            onClick={() => {
