...
const TryIt = (): ReactElement => {
    ...
    const onArgsChange = (event: React.ChangeEvent<HTMLTextAreaElement>): void => {
        setArgsText(event.target.value);
    };

    // ⌘/Ctrl+Enter fires the request from the editor, like a typical request console.
    const onArgsKeyDown = (event: React.KeyboardEvent<HTMLTextAreaElement>): void => {
    ...
    return (
        <div className="overflow-hidden rounded-xl border border-border bg-card" data-testid="api-try-it">
