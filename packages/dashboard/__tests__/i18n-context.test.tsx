...
import { createDashboardI18n, DEFAULT_LOCALE, useT } from "../src/i18n-context.js";
import { DashboardI18nProvider } from "../src/i18n-provider.js";
...
describe("i18n-context", () => {
    ...
    describe("createDashboardI18n", () => {
        ...
        // when NODE_ENV !== "production". The dashboard ships as a library, so we
        ...
        it("resolves a registered translation for the active locale", () => {
            ...
            const i18n = createDashboardI18n("de", catalogs);
        ...
        it("falls back to the default locale for an unknown code", () => {
            ...
            const i18n = createDashboardI18n("zz");
    ...
    describe("useT", () => {
        ...
        it("uses the instance supplied by DashboardI18nProvider", () => {
            expect.assertions(1);

            const i18n = createDashboardI18n("de", { de: { Clear: "Löschen" }, en: {} });
