...
export default createConfig(
    ...
    // warning so current code passes lint.
    {
        ...
        rules: {
            ...
            // Irreconcilable with the react block's `react/sort-comp`, which
            // wants `render` last while member-ordering wants it before private
            // instance methods (ErrorBoundary has a private `reset` field).
            ...
            // Named React components/hooks (function declarations) give stable
            // display names in DevTools and readable stack traces; converting to
            // expressions is a DX regression, not a fix.
            "func-style": "off",
            ...
            // `void promise` is the idiomatic floating-promise marker for
            // fire-and-forget calls in effects/handlers; removing it trips
            // no-floating-promises/no-misused-promises instead.
            "no-void": "off",
