...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
    return (
        <th
            ...
            className={cn(
                "h-9 border-e border-border px-3 text-start align-middle text-xs font-medium whitespace-nowrap text-muted-foreground last:border-e-0 [&:has([role=checkbox])]:pe-0",
                className,
            )}
            {...props}
        />
