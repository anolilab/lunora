...
interface WranglerConfig {
    ...
    // `bucket_name` is the remote bucket the binding points at. Projected here
    // (wrangler has always required it) so a consumer can name the real bucket
    // in a diagnostic instead of the binding alias.
