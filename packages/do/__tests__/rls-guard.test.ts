...
const createFakeWriter = () => {
    return {
        aggregate: vi.fn((tableName: string) => Promise.resolve(`aggregate:${tableName}`)),
        count: vi.fn((tableName: string) => Promise.resolve(`count:${tableName}`)),
        delete: vi.fn((id: string) => Promise.resolve(`delete:${id}`)),
        findFirst: vi.fn((tableName: string) => Promise.resolve(`findFirst:${tableName}`)),
        findFirstOrThrow: vi.fn((tableName: string) => Promise.resolve(`findFirstOrThrow:${tableName}`)),
        findMany: vi.fn((tableName: string) => Promise.resolve(`findMany:${tableName}`)),
        get: vi.fn((id: string) => Promise.resolve(`get:${id}`)),
        groupBy: vi.fn((tableName: string) => Promise.resolve(`groupBy:${tableName}`)),
        insert: vi.fn((tableName: string) => Promise.resolve(`insert:${tableName}`)),
        patch: vi.fn((id: string) => Promise.resolve(`patch:${id}`)),
        query: vi.fn((tableName: string) => `query:${tableName}`),
        rank: vi.fn((tableName: string) => Promise.resolve(`rank:${tableName}`)),
        rankBefore: vi.fn((tableName: string) => Promise.resolve(`rankBefore:${tableName}`)),
        rankPage: vi.fn((tableName: string) => Promise.resolve(`rankPage:${tableName}`)),
        replace: vi.fn((id: string) => Promise.resolve(`replace:${id}`)),
    };
};
