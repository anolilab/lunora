...
// Self-contained flat config for @lunora/hyperdrive. Each package owns its own
...
export default createConfig(
    ...
    // chain line breaks; number-literal-case wants uppercase hex digits Prettier lowercases.
    {
        rules: {
            ...
            // The dialect contract (`src/dialect.ts`) is a heavily-documented interface;
            // jsdoc/check-indentation misfires on its member JSDoc (anchoring a phantom
            // "must be no indentation" to the interface node) where the content is
            // verifiably single-space-aligned. Off for this package's interface-heavy core.
