/**
 * `@cirrus/ssr` — the framework-neutral server contract that every Cirrus
...
// Preload a query into a serializable snapshot (re-exported from @cirrus/client,
// the canonical home of `preloadQuery`).
