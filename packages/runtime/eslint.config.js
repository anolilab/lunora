...
export default createConfig(
    ...
    // warning so current code passes lint.
    {
        ...
        rules: {
            ...
            // Kept off: the runtime deliberately mixes top-level `function`
            // declarations (hoisted helpers) with arrow `const`s; the rule's
            // expression-only style would force churn against that convention.
            "func-style": "off",
            "import/no-unresolved": "off",
            "import/prefer-default-export": "off",
            // Kept off: JSDoc here uses intentional indentation inside fenced
            // code examples and numbered wiring steps, which this rule flags.
            "jsdoc/check-indentation": "off",
            // Kept off: `{@link}` cross-references point at sibling interface
            // members / local symbols (e.g. `authorizeShard`, `MergeStrategy`)
            // that jsdoc's type resolver cannot see — false positives only.
    ...
    // Test files: relax rules.
    {
        ...
        rules: {
            ...
            // Test workers (mock DOs / Worker entrypoints) interleave exports.
