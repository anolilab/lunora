...
they generated (recorded in a `// lunora:crons [...]` comment above the array) —
an entry you hand-wrote for `backupCron` is left alone. To restore a scheduled snapshot, download the
