...
> `materializeExternalRows` can diff it. The declarative `.source()` table modifier
> (planned) automates this whole loop — full-pull diff, tenant scoping, and a poll
> cadence — so you won't hand-write the action/mutation/cron.
