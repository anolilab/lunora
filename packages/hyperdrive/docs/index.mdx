...
bridge above, on your own schedule). `mode: "incremental"` is reserved for a future
release; `defineSchema` rejects it today (only the default full-pull is implemented).
