...
description: Provider-agnostic payments for Lunora — Stripe/Polar/Autumn adapters, webhook sync, and a payment/subscription state machine.
---

`@lunora/payment` is one provider-agnostic API over Stripe, Polar, and Autumn. Webhook
...
| Option          | Type                 | Notes                                                                                      |
| --------------- | -------------------- | ------------------------------------------------------------------------------------------ |
| `adapter`       | `PaymentAdapter`     | Built with `createStripeAdapter` / `createPolarAdapter` / `createAutumnAdapter`. Required. |
...
```ts
import { createAutumnAdapter, createPolarAdapter, createStripeAdapter } from "@lunora/payment";
...
| Option                    | Stripe | Polar | Autumn | Notes                                                                   |
| ------------------------- | :----: | :---: | :----: | ----------------------------------------------------------------------- |
| `client`                  |   ✓    |   ✓   |   ✓    | Structural `StripeClientLike` / `PolarClientLike` / `AutumnClientLike`. |
