...
```ts
import { createAutumnAdapter, createCreemAdapter, createDodoPaymentsAdapter, createPolarAdapter, createStripeAdapter } from "@lunora/payment";
...
| ------------------------- | :----: | :---: | :----: | :--: | :---: | --------------------------------------------------------------------------------- |
| `client`                  |   ✓    |   ✓   |   ✓    |  ✓   |   ✓   | Structural `…ClientLike` per provider (`StripeClientLike`, `CreemClientLike`, …). |
