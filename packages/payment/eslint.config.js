...
// Self-contained flat config for @lunora/payment. Each package owns its own
...
export default createConfig(
    ...
    // Uppercase error-code constants (e.g. WEBHOOK_SIGNATURE_INVALID) read as high-entropy to
    // no-secrets, but they're public PaymentErrorCode values, not credentials.
    {
        rules: {
