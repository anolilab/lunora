...
const createBackupCodeSignInController = (context: ControllerContext, options: { trustDevice?: boolean } = {}): FormController<BackupCodeSignInField> => {
    return createFormController<BackupCodeSignInField>(context, {
...
export type { BackupCodeSignInField, BackupCodesField, BackupCodesHandle };
export { createBackupCodeSignInController, createBackupCodesController };
