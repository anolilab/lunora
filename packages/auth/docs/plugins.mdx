...
the module-level helpers above hand back `Date`s.

Inviting from the studio still sends nothing — delivery is the app's, wherever
the invitation is issued from.
