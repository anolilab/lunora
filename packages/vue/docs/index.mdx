...
<Callout type="warn">
    **Preview.** The Vue adapter exists and exposes the same hydrate-then-subscribe handoff as React, but it is **preview** maturity — not yet proven end-to-end
    against a running app. The React adapter is the only one verified through the full live-loader path. See [Bring your
