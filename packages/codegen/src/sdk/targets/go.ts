...
import { toPascalCase } from "../spec";
import type { SdkRenderInput, SdkTarget } from "../target";

const GENERATED_HEADER = "// GENERATED by `lunora sdk generate --lang go` — do not edit.\n// Run the command again to regenerate.\n\n";
...
const renderCall = (namespaceType: string, method: SdkMethod): string => {
    ...
    const call = `lunora.Call[${returns}](a.client, "${method.verb}", "${method.functionPath}", ${payload}, shardKey)`;
