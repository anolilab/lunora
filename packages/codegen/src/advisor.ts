...
import type { AuthApiCallIR, InsertWriteIR, QueryReadIR, SchemaIR, TableIR } from "./ir";
...
): Finding[] => runAdvisor({ authApiCalls, inserts, queries, schema: toAdvisorSchema(schema) }, { source: "static" });
