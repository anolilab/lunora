...
export const openApiSpec: Record<string, unknown> = {
    ...
    "paths": {
        ...
        "/_lunora/rpc#notes:summary": {
            "post": {
                "description": "Invoke the `query` `notes:summary` over the Lunora RPC envelope (POST /_lunora/rpc).",
                "operationId": "notes:summary",
                "requestBody": {
                    "content": {
                        "application/json": {
                            "schema": {
