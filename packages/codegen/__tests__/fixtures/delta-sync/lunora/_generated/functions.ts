...
export const LUNORA_SHAPES: Record<string, RegisteredShape> = {
    "boardNotes": lunora_shapes_1.boardNotes as unknown as RegisteredShape,
    "myBoards": lunora_shapes_1.myBoards as unknown as RegisteredShape,
};
