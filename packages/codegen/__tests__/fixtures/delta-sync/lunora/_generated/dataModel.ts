...
export type TableName = "notes" | "boards" | "contacts";
 ...
 * ```
 */
export type AppTableName = "notes" | "boards" | "contacts";
...
export interface Insert_contacts {
    _id?: Id<"contacts">;
    _creationTime?: number;
    boardId: string;
    email: string;
