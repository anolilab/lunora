...
import type { AdvisorProcedure, AdvisoryFinding, DatabaseWriterLike, DataMigrationLike, KeyRange, MaskPoliciesResult, MigrationRunResult, RunShardApplyCdcArgs, RunShardMigrationArgs, RlsPoliciesResult, RunShardRankBeforeArgs, RunShardRankPageArgs, RunShardWriteArgs, RunShardWriteResult, SchedulerLike, TransactionHeadroomTracker, SchemaLike, ShardDOState, ShardRankPageResult, SqlExec, StorageRulesResult, StudioFeaturesResult, SystemReaderStorageLike, TelemetrySink } from "@lunora/do";
import { applyCdcChanges, createReadFootprint, createShardCtxDb, runDataMigration, runShardMigrations, serveRelationFanout, ShardDO as ShardDOBase } from "@lunora/do";
...
const LUNORA_SCHEMA_SNAPSHOT: { hash: string; json: string } = { hash: "973872d7e57e35b5", json: "{\n  \"migrationIds\": [\n    \"backfill-read-by\"\n  ],\n  \"tables\": {\n    \"attachments\": {\n      \"fields\": {\n        \"bytes\": {\n          \"kind\": \"bytes\",\n          \"optional\": false\n        },\n        \"fileKey\": {\n          \"kind\": \"storage\",\n          \"optional\": false\n        },\n        \"ownerId\": {\n          \"kind\": \"id\",\n          \"optional\": false\n        },\n        \"size\": {\n          \"kind\": \"bigint\",\n          \"optional\": false\n        },\n        \"tags\": {\n          \"kind\": \"array\",\n          \"optional\": false\n        },\n        \"title\": {\n          \"kind\": \"string\",\n          \"optional\": true\n        }\n      },\n      \"indexes\": {},\n      \"relations\": {\n        \"owner\": {\n          \"field\": \"ownerId\",\n          \"kind\": \"one\",\n          \"table\": \"users\"\n        }\n      },\n      \"shardMode\": \"global\"\n    },\n    \"messages\": {\n      \"fields\": {\n        \"channelId\": {\n          \"kind\": \"id\",\n          \"optional\": false\n        },\n        \"text\": {\n          \"kind\": \"string\",\n          \"optional\": false\n        }\n      },\n      \"indexes\": {\n        \"by_channel\": {\n          \"fields\": [\n            \"channelId\"\n          ],\n          \"unique\": false\n        }\n      },\n      \"relations\": {},\n      \"shardMode\": \"shardBy:channelId\"\n    },\n    \"places\": {\n      \"fields\": {\n        \"location\": {\n          \"kind\": \"geoPoint\",\n          \"optional\": false\n        },\n        \"name\": {\n          \"kind\": \"string\",\n          \"optional\": false\n        }\n      },\n      \"indexes\": {},\n      \"relations\": {},\n      \"shardMode\": \"root\"\n    },\n    \"sessions\": {\n      \"fields\": {\n        \"expiresAt\": {\n          \"kind\": \"timestamp\",\n          \"optional\": false\n        },\n        \"token\": {\n          \"kind\": \"string\",\n          \"optional\": false\n        }\n      },\n      \"indexes\": {},\n      \"relations\": {},\n      \"shardMode\": \"root\"\n    },\n    \"users\": {\n      \"fields\": {\n        \"email\": {\n          \"kind\": \"string\",\n          \"optional\": false\n        },\n        \"name\": {\n          \"kind\": \"string\",\n          \"optional\": false\n        },\n        \"role\": {\n          \"kind\": \"literal\",\n          \"optional\": false\n        },\n        \"prefs\": {\n          \"kind\": \"record\",\n          \"optional\": false\n        }\n      },\n      \"indexes\": {\n        \"by_email\": {\n          \"fields\": [\n            \"email\"\n          ],\n          \"unique\": true\n        }\n      },\n      \"relations\": {\n        \"attachments\": {\n          \"field\": \"ownerId\",\n          \"kind\": \"many\",\n          \"table\": \"attachments\"\n        }\n      },\n      \"shardMode\": \"global\"\n    }\n  },\n  \"version\": 1\n}\n" };
