...
const CIRRUS_TABLE_COLUMNS: Record<string, Array<{ isStorage?: boolean; name: string; optional: boolean; pk?: boolean; ref?: string; type: string }>> = {
    "messages": [
        {
            "name": "_id",
            "optional": false,
...
const CIRRUS_MASK_METADATA: MaskPoliciesResult = {
    "columns": []
};
...
const CIRRUS_STUDIO_FEATURES: StudioFeaturesResult = {
    "mail": false,
    "payments": false,
    "scheduler": false,
    "storage": true,
