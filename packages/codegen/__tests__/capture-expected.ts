...
writeFileSync(join(expectedDirectory, "app.ts"), result.generated.app, "utf8");
...
writeFileSync(join(expectedDirectory, "openapi.ts"), result.generated.openApiModule, "utf8");
writeFileSync(join(expectedDirectory, "openrpc.json"), result.generated.openRpc, "utf8");
writeFileSync(join(expectedDirectory, "openrpc.ts"), result.generated.openRpcModule, "utf8");
