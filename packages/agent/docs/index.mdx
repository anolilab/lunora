...
- **`telemetry`** — an ai@7 `TelemetryOptions` handed to every turn; set
  ...
  [`@lunora/agent-telemetry`](/docs/packages/agent-telemetry) ships ready-made
  ones — `consoleTelemetry` (zero-dependency), `combineTelemetry`, and the
...
- [@lunora/agent-telemetry](/docs/packages/agent-telemetry) — ready-made `telemetry.integrations` (console, Sentry, Braintrust)
