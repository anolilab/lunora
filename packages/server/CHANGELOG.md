...
## @lunora/server [1.0.0-alpha.151](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.150...@lunora/server@1.0.0-alpha.151) (2026-09-26)
...
## @lunora/server [1.0.0-alpha.150](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.149...@lunora/server@1.0.0-alpha.150) (2026-09-26)
...
## @lunora/server [1.0.0-alpha.149](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.148...@lunora/server@1.0.0-alpha.149) (2026-09-26)
...
## @lunora/server [1.0.0-alpha.148](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.147...@lunora/server@1.0.0-alpha.148) (2026-09-26)
...
## @lunora/server [1.0.0-alpha.147](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.146...@lunora/server@1.0.0-alpha.147) (2026-09-25)
...
## @lunora/server [1.0.0-alpha.146](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.145...@lunora/server@1.0.0-alpha.146) (2026-09-25)
...
## @lunora/server [1.0.0-alpha.145](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.144...@lunora/server@1.0.0-alpha.145) (2026-09-25)
...
## @lunora/server [1.0.0-alpha.144](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.143...@lunora/server@1.0.0-alpha.144) (2026-09-25)
...
## @lunora/server [1.0.0-alpha.141](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.140...@lunora/server@1.0.0-alpha.141) (2026-09-25)
...
## @lunora/server [1.0.0-alpha.140](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.139...@lunora/server@1.0.0-alpha.140) (2026-09-25)
...
## @lunora/server [1.0.0-alpha.139](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.138...@lunora/server@1.0.0-alpha.139) (2026-09-24)
...
## @lunora/server [1.0.0-alpha.138](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.137...@lunora/server@1.0.0-alpha.138) (2026-09-24)
...
## @lunora/server [1.0.0-alpha.137](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.136...@lunora/server@1.0.0-alpha.137) (2026-09-24)
...
## @lunora/server [1.0.0-alpha.136](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.135...@lunora/server@1.0.0-alpha.136) (2026-09-23)


### Dependencies

* **@lunora/scheduler:** upgraded to 1.0.0-alpha.78

## @lunora/server [1.0.0-alpha.135](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.134...@lunora/server@1.0.0-alpha.135) (2026-09-23)
...
## @lunora/server [1.0.0-alpha.132](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.131...@lunora/server@1.0.0-alpha.132) (2026-09-21)
...
## @lunora/server [1.0.0-alpha.123](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.122...@lunora/server@1.0.0-alpha.123) (2026-09-12)
...
## @lunora/server [1.0.0-alpha.120](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.119...@lunora/server@1.0.0-alpha.120) (2026-09-12)
...
## @lunora/server [1.0.0-alpha.106](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.105...@lunora/server@1.0.0-alpha.106) (2026-09-06)
...
## @lunora/server [1.0.0-alpha.105](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.104...@lunora/server@1.0.0-alpha.105) (2026-09-06)
...
## @lunora/server [1.0.0-alpha.104](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.103...@lunora/server@1.0.0-alpha.104) (2026-09-05)
...
## @lunora/server [1.0.0-alpha.103](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.102...@lunora/server@1.0.0-alpha.103) (2026-09-05)

### ⚠ BREAKING CHANGES

* **runtime:** `HttpActionCtx` / `HttpActionContext` gain a required `forShard(shardKey)`
member. Anything constructing one structurally (rather than receiving it from the worker) must
supply it.

Known ceiling left in place: the SSE `.stream()` pump drives the whole user iterator inside
`start()` without consulting `controller.desiredSize`, so a generator outrunning its reader
buffers in worker memory. Cancel is honored, so nothing runs past a disconnect. Documented at the
site with the upgrade path; the surface is `@experimental`.

Co-Authored-By: Claude Opus 5 (1M context) <noreply@anthropic.com>
Claude-Session: https://claude.ai/code/session_01VUuYamsU1YLmAQhtut9PLZ

* chore(api): accept the HttpRunners and forShard surface

Adding `ctx.forShard(key)` to an HTTP action's context introduces `HttpRunners`
and widens `HttpActionContext`; the umbrella re-export follows.
...
* **runtime:** route an HTTP action's ctx.run* through the shared shard dispatcher ([#610](https://github.com/anolilab/lunora/issues/610)) ([9726036](https://github.com/anolilab/lunora/commit/97260367526635da0e9bac952cbae9ac76f7d21f))
...
## @lunora/server [1.0.0-alpha.102](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.101...@lunora/server@1.0.0-alpha.102) (2026-09-04)
...
## @lunora/server [1.0.0-alpha.101](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.100...@lunora/server@1.0.0-alpha.101) (2026-09-03)
...
## @lunora/server [1.0.0-alpha.100](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.99...@lunora/server@1.0.0-alpha.100) (2026-09-03)
...
## @lunora/server [1.0.0-alpha.99](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.98...@lunora/server@1.0.0-alpha.99) (2026-09-02)
...
## @lunora/server [1.0.0-alpha.98](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.97...@lunora/server@1.0.0-alpha.98) (2026-09-01)
...
## @lunora/server [1.0.0-alpha.97](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.96...@lunora/server@1.0.0-alpha.97) (2026-09-01)
...
## @lunora/server [1.0.0-alpha.96](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.95...@lunora/server@1.0.0-alpha.96) (2026-09-01)
...
## @lunora/server [1.0.0-alpha.95](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.94...@lunora/server@1.0.0-alpha.95) (2026-08-31)
...
## @lunora/server [1.0.0-alpha.90](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.89...@lunora/server@1.0.0-alpha.90) (2026-08-27)
...
## @lunora/server [1.0.0-alpha.89](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.88...@lunora/server@1.0.0-alpha.89) (2026-08-27)
...
## @lunora/server [1.0.0-alpha.88](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.87...@lunora/server@1.0.0-alpha.88) (2026-08-27)
...
## @lunora/server [1.0.0-alpha.83](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.82...@lunora/server@1.0.0-alpha.83) (2026-08-26)
...
## @lunora/server [1.0.0-alpha.82](https://github.com/anolilab/lunora/compare/@lunora/server@1.0.0-alpha.81...@lunora/server@1.0.0-alpha.82) (2026-08-25)
