...
const makeQueryContext = (): QueryContext => {
    return {
        ...
        now: 0,
        runQuery: vi.fn<(...args: never[]) => unknown>() as unknown as QueryContext["runQuery"],
...
const makeMutationContext = (): MutationContext => {
    return {
        ...
        now: 0,
        runMutation: vi.fn<(...args: never[]) => unknown>() as unknown as MutationContext["runMutation"],
        runQuery: vi.fn<(...args: never[]) => unknown>() as unknown as MutationContext["runQuery"],
...
const makeActionContext = (): ActionContext => {
    return {
        ...
        now: 0,
        runAction: vi.fn<(...args: never[]) => unknown>() as unknown as ActionContext["runAction"],
        runMutation: vi.fn<(...args: never[]) => unknown>() as unknown as ActionContext["runMutation"],
        runQuery: vi.fn<(...args: never[]) => unknown>() as unknown as ActionContext["runQuery"],
