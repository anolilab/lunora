...
The platform health check waits for an **open port** (`defaultPort`, or
`pingEndpoint` if set) — not necessarily a _ready_ app. `readyOn` adds
...
- [Limits](/docs/limits)
- [@lunora/scheduler](/docs/packages/scheduler)
- [@lunora/storage](/docs/packages/storage)
