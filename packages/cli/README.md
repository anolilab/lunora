...
Workspace dependencies: [`@cirrus/codegen`](../codegen), [`@cirrus/config`](../config), [`@cirrus/vite`](../vite).
...
Delegates to [`@cirrus/codegen`](../codegen). Run after editing `cirrus/schema.ts` or any function file when you're not running the dev server.
