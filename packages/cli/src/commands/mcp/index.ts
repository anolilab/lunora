...
const mcpCommand: Command = {
    ...
    options: [
        ...
        { description: "install/uninstall: print what would change instead of writing it", name: "print", type: Boolean },
        ...
        {
            description: "install/uninstall: the machine-wide config (install default: docs server global, local server per-project)",
            name: "global",
            type: Boolean,
        },
