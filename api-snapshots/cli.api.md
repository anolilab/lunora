...
```ts
type Template = "analog" | "astro" | "expo" | "next" | "nuxt" | "react-router" | "saas" | "solid-v2" | "standalone" | "sveltekit" | "tanstack-start-react" | "tanstack-start-solid" | "vinext" | "vinext-pages";
```
