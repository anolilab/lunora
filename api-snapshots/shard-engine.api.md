...
### `FanoutAttachmentLike` (interface)
...
### `ReadQueueMessagesOptions` (interface)
...
### `SocketAttachmentLike` (interface)
...
### `SubscriptionFrameInput` (interface)
