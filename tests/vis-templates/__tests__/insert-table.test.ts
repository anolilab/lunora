...
const baseSchema = `import { defineSchema, defineTable, v } from "lunorash/server";
...
describe("insertTableIntoSchema", () => {
    ...
    test("rejects defineSchema called with a non-object literal argument", () => {
        const source = `import { defineSchema } from "lunorash/server";
...
`;
    ...
    test("reports no-define-schema when the import is aliased", () => {
        ...
        const source = `import { defineSchema as ds } from "lunorash/server";
