...
// Default to "dark" during SSR (matches the reference's default data-theme),
// then reconcile to the user's OS preference on mount to avoid a hydration
// mismatch. The toggle flips data-theme on the .lunora-welcome root.
...
<template>
    <div class="lunora-welcome" :data-theme="theme">
        ...
        <div class="lw-wrap">
            ...
            <div class="grid">
                <a class="card feature" href="https://lunora.sh/docs">
                    <div class="shot" aria-hidden="true">
                        ...
                        <div class="body">
                            <div class="nav">
                                <i style="width: 80%"></i><i style="width: 60%"></i><i style="width: 72%"></i><i style="width: 50%"></i
                                ><i style="width: 66%"></i><i style="width: 44%"></i><i style="width: 58%"></i>
                            </div>
                            <div class="doc">
                                <span class="h"></span><i style="width: 92%"></i><i style="width: 88%"></i><span class="accent"></span><i style="width: 80%"></i
                                ><i style="width: 90%"></i><i style="width: 72%"></i><i style="width: 84%"></i><i style="width: 78%"></i>
                            </div>
                        </div>
                    </div>
                    <div class="info">
            ...
            <div class="lw-foot">Running on Lunora · Nuxt</div>
        </div>
    </div>
</template>

<!-- NON-scoped: the reference CSS is already namespaced under `.lunora-welcome`,
