...
//
// Class-B note (PLAN4 §3): `src/worker.ts` folds the adapter-emitted handler
// into the generated `defineApp()` builder via `.buildFrameworkWorker(...)`
// for the deployed single-worker composition; it is only referenced by
// `lunora deploy`, not by the `vite build` here.
//
