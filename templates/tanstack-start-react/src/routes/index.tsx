...
function WelcomePage() {
    // SSR-safe: default to "dark" so server and first client render match. After
    // mount we reconcile to the OS preference, then the toggle button takes over.
    ...
    return (
        <div className="lunora-welcome" data-theme={theme}>
            ...
            <div className="lw-wrap">
                ...
                <div className="lw-foot">Running on Lunora · TanStack Start + React</div>
            </div>
        </div>
    );
}
