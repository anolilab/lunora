import { clampChroma, converter, formatRgb, interpolate, parse, type Oklch, type Rgb } from "culori";
...
export function mixOklch(a: string, b: string, t: number): string {
    const mixed = clampChroma(interpolate([resolveColorString(a), resolveColorString(b)], "oklch")(t), "oklch", "rgb");
