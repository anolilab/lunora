...
> The visual spec for Lunora across the docs/marketing site, Studio, and videos.
> Source of truth for color, surface, type, and motion. The consumable tokens
> live alongside this file in `./tokens.css` (Tailwind v4) and `./tokens.ts`
> (JS/TS), and still inline in `apps/docs/src/styles/app.css`; this document
