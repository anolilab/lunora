...
const DeviceAuthorizationCard = ({ userCode }: DeviceAuthorizationCardProps = {}): ReactElement | null => {
    ...
    return (
        <AuthCard title={t.deviceTitle}>
            <FormBanner error={state.error} />
            <Field field={{ touched: false, value: state.code }} label={t.deviceCodeLabel} name="user_code" onBlur={() => {}} onChange={actions.setCode} />
...
const TeamsCard = (): ReactElement | null => {
    ...
    return (
        <AuthCard title={t.teams}>
            ...
            >
                <Field field={{ touched: false, value: name }} label={t.teamNameLabel} name="team" onBlur={() => {}} onChange={setName} />
