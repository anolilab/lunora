...
export const openApiSpec: Record<string, unknown> = {
    ...
    "openapi": "3.1.0",
    "paths": {
        "/_lunora/rpc#documents:create": {
            "post": {
                "description": "Invoke the `mutation` `documents:create` over the Lunora RPC envelope (POST /_lunora/rpc).",
        ...
        "/_lunora/rpc#documents:list": {
            "post": {
                "description": "Invoke the `query` `documents:list` over the Lunora RPC envelope (POST /_lunora/rpc).",
    ...
    "tags": [
        {
            "description": "Operations declared in `lunora/documents`.",
            "name": "documents"
        }
    ]
};
