...
const LUNORA_TABLE_REFS = JSON.parse("{\"votes\":{\"feedbackId\":\"feedback\"},\"comments\":{\"feedbackId\":\"feedback\"}}") as Record<string, Record<string, string>>;

/** Declared indexes per table (secondary, search, geo, rank, vector) for the schema viewer. */
const LUNORA_TABLE_INDEXES = JSON.parse("{\"feedback\":[{\"fields\":[\"upvoteCount\"],\"name\":\"by_upvotes\",\"type\":\"index\"},{\"fields\":[\"status\"],\"name\":\"by_status\",\"type\":\"index\"}],\"votes\":[{\"fields\":[\"voterEmail\"],\"name\":\"by_voter\",\"type\":\"index\"},{\"fields\":[\"feedbackId\",\"voterEmail\"],\"name\":\"by_feedback_and_voter\",\"type\":\"index\",\"unique\":true}],\"comments\":[{\"fields\":[\"feedbackId\"],\"name\":\"by_feedback\",\"type\":\"index\"}],\"summaries\":[{\"fields\":[\"generatedAt\"],\"name\":\"by_generated\",\"type\":\"index\"}],\"ratelimit_buckets\":[{\"fields\":[\"key\"],\"name\":\"by_key\",\"type\":\"index\"}]}") as Record<string, Array<{ fields: string[]; name: string; type: "geo" | "index" | "rank" | "search" | "vector"; unique?: boolean }>>;

/** Columns per table (typed, with PK/FK markers) for the studio's schema diagram, served via `__lunora_admin__:describeTable`. */
const LUNORA_TABLE_COLUMNS = JSON.parse("{\"feedback\":[{\"name\":\"_id\",\"optional\":false,\"pk\":true,\"type\":\"id\"},{\"name\":\"_creationTime\",\"optional\":false,\"type\":\"number\"},{\"name\":\"title\",\"optional\":false,\"type\":\"string\"},{\"name\":\"description\",\"optional\":false,\"type\":\"string\"},{\"name\":\"status\",\"optional\":false,\"type\":\"union\",\"enumValues\":[\"open\",\"under-review\",\"planned\",\"in-progress\",\"completed\",\"closed\"]},{\"name\":\"authorName\",\"optional\":false,\"type\":\"string\"},{\"name\":\"authorEmail\",\"optional\":true,\"type\":\"string\"},{\"name\":\"upvoteCount\",\"optional\":false,\"type\":\"number\"},{\"name\":\"commentCount\",\"optional\":false,\"type\":\"number\"},{\"name\":\"tags\",\"optional\":true,\"type\":\"array\"}],\"votes\":[{\"name\":\"_id\",\"optional\":false,\"pk\":true,\"type\":\"id\"},{\"name\":\"_creationTime\",\"optional\":false,\"type\":\"number\"},{\"name\":\"feedbackId\",\"optional\":false,\"type\":\"id\",\"ref\":\"feedback\"},{\"name\":\"voterEmail\",\"optional\":false,\"type\":\"string\"}],\"comments\":[{\"name\":\"_id\",\"optional\":false,\"pk\":true,\"type\":\"id\"},{\"name\":\"_creationTime\",\"optional\":false,\"type\":\"number\"},{\"name\":\"feedbackId\",\"optional\":false,\"type\":\"id\",\"ref\":\"feedback\"},{\"name\":\"authorName\",\"optional\":false,\"type\":\"string\"},{\"name\":\"authorEmail\",\"optional\":true,\"type\":\"string\"},{\"name\":\"content\",\"optional\":false,\"type\":\"string\"},{\"name\":\"isOfficial\",\"optional\":false,\"type\":\"boolean\"}],\"summaries\":[{\"name\":\"_id\",\"optional\":false,\"pk\":true,\"type\":\"id\"},{\"name\":\"_creationTime\",\"optional\":false,\"type\":\"number\"},{\"name\":\"title\",\"optional\":false,\"type\":\"string\"},{\"name\":\"summary\",\"optional\":false,\"type\":\"string\"},{\"name\":\"feedbackIds\",\"optional\":false,\"type\":\"array\"},{\"name\":\"generatedAt\",\"optional\":false,\"type\":\"number\"}],\"ratelimit_buckets\":[{\"name\":\"_id\",\"optional\":false,\"pk\":true,\"type\":\"id\"},{\"name\":\"_creationTime\",\"optional\":false,\"type\":\"number\"},{\"name\":\"key\",\"optional\":false,\"type\":\"string\"},{\"name\":\"value\",\"optional\":false,\"type\":\"number\"},{\"name\":\"ts\",\"optional\":false,\"type\":\"number\"},{\"name\":\"prev\",\"optional\":true,\"type\":\"number\"}]}") as Record<
    string,
    Array<{
        bucket?: string;
        enumValues?: string[];
...
const LUNORA_ADVISOR_PROCEDURES = JSON.parse("[{\"callsMail\":false,\"emitsEvent\":false,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":false,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"list\",\"file\":\"feedback\",\"hasEmailArg\":false,\"kind\":\"query\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":false,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":false,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"get\",\"file\":\"feedback\",\"hasEmailArg\":false,\"kind\":\"query\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":false,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":false,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"comments\",\"file\":\"feedback\",\"hasEmailArg\":false,\"kind\":\"query\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":false,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":false,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"myVotes\",\"file\":\"feedback\",\"hasEmailArg\":true,\"kind\":\"query\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":true,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"create\",\"file\":\"feedback\",\"hasEmailArg\":true,\"kind\":\"mutation\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":true,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"setStatus\",\"file\":\"feedback\",\"hasEmailArg\":false,\"kind\":\"mutation\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":true,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"toggleVote\",\"file\":\"feedback\",\"hasEmailArg\":true,\"kind\":\"mutation\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":true,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"addComment\",\"file\":\"feedback\",\"hasEmailArg\":true,\"kind\":\"mutation\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":true,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"remove\",\"file\":\"feedback\",\"hasEmailArg\":false,\"kind\":\"mutation\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":false,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":false,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"list\",\"file\":\"summaries\",\"hasEmailArg\":false,\"kind\":\"query\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":true,\"fanOut\":false,\"handlesErrors\":true,\"reachesOutbound\":true,\"runsAiGeneration\":true,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"generate\",\"file\":\"summaries\",\"hasEmailArg\":false,\"kind\":\"action\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":false,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":false,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"store\",\"file\":\"summaries\",\"hasEmailArg\":false,\"kind\":\"mutation\",\"visibility\":\"internal\"},{\"callsMail\":false,\"emitsEvent\":true,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"remove\",\"file\":\"summaries\",\"hasEmailArg\":false,\"kind\":\"mutation\",\"visibility\":\"public\"}]") as AdvisorProcedure[];
...
const LUNORA_STUDIO_FEATURES = JSON.parse("{\"analytics\":false,\"auth\":false,\"containers\":false,\"flags\":false,\"kv\":false,\"mail\":false,\"notifications\":false,\"payments\":false,\"queues\":false,\"scheduler\":false,\"storage\":false,\"vectors\":false,\"workflows\":false,\"platform\":{\"features\":{\"shardedState\":\"native\",\"globalTables\":\"native\",\"websocketHibernation\":\"native\",\"durableStreams\":\"emulated\",\"commitOrderedTables\":\"native\",\"localSql\":\"native\",\"serverReactors\":\"emulated\",\"memoryTables\":\"emulated\",\"shardAlarms\":\"native\",\"shardPlacement\":\"native\",\"shardReadReplicas\":\"emulated\",\"crossShardFanout\":\"emulated\",\"queues\":\"native\",\"relationGraph\":\"emulated\",\"workflows\":\"native\",\"scheduler\":\"emulated\",\"cronTriggers\":\"native\",\"authJurisdictionMove\":\"native\",\"agents\":\"emulated\",\"objectStorage\":\"native\",\"objectStorageBackups\":\"emulated\",\"objectStorageCdcArchive\":\"emulated\",\"keyValueStore\":\"native\",\"vectorStore\":\"native\",\"ai\":\"native\",\"browser\":\"native\",\"images\":\"native\",\"containers\":\"native\",\"analytics\":\"native\",\"edgeRequestMetadata\":\"native\",\"hostTraceFusion\":\"native\",\"logArchive\":\"native\",\"pipelines\":\"native\",\"pointInTimeRecovery\":\"native\",\"mail\":\"emulated\",\"secrets\":\"native\",\"hyperdrive\":\"native\",\"httpCache\":\"native\",\"identityProxy\":\"native\"},\"id\":\"cloudflare\",\"name\":\"Cloudflare\"}}") as StudioFeaturesResult;
...
const LUNORA_SCHEMA_SNAPSHOT: { hash: string; json: string } = { hash: "07dfcb7ffeadcad9", json: "{\n  \"migrationIds\": [],\n  \"tables\": {\n    \"comments\": {\n      \"commitOrdered\": false,\n      \"fields\": {\n        \"authorEmail\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": true,\n          \"unique\": false\n        },\n        \"authorName\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"content\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"feedbackId\": {\n          \"kind\": \"id\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false,\n          \"ref\": \"feedback\"\n        },\n        \"isOfficial\": {\n          \"kind\": \"boolean\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        }\n      },\n      \"indexes\": {\n        \"by_feedback\": {\n          \"fields\": [\n            \"feedbackId\"\n          ],\n          \"unique\": false\n        }\n      },\n      \"memory\": false,\n      \"relations\": {},\n      \"shardMode\": \"root\"\n    },\n    \"feedback\": {\n      \"commitOrdered\": false,\n      \"fields\": {\n        \"authorEmail\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": true,\n          \"unique\": false\n        },\n        \"authorName\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"commentCount\": {\n          \"kind\": \"number\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"description\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"status\": {\n          \"kind\": \"union\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false,\n          \"members\": [\n            {\n              \"kind\": \"literal\",\n              \"nullable\": false,\n              \"optional\": false,\n              \"unique\": false,\n              \"literal\": \"\\\"closed\\\"\"\n            },\n            {\n              \"kind\": \"literal\",\n              \"nullable\": false,\n              \"optional\": false,\n              \"unique\": false,\n              \"literal\": \"\\\"completed\\\"\"\n            },\n            {\n              \"kind\": \"literal\",\n              \"nullable\": false,\n              \"optional\": false,\n              \"unique\": false,\n              \"literal\": \"\\\"in-progress\\\"\"\n            },\n            {\n              \"kind\": \"literal\",\n              \"nullable\": false,\n              \"optional\": false,\n              \"unique\": false,\n              \"literal\": \"\\\"open\\\"\"\n            },\n            {\n              \"kind\": \"literal\",\n              \"nullable\": false,\n              \"optional\": false,\n              \"unique\": false,\n              \"literal\": \"\\\"planned\\\"\"\n            },\n            {\n              \"kind\": \"literal\",\n              \"nullable\": false,\n              \"optional\": false,\n              \"unique\": false,\n              \"literal\": \"\\\"under-review\\\"\"\n            }\n          ]\n        },\n        \"tags\": {\n          \"kind\": \"array\",\n          \"nullable\": false,\n          \"optional\": true,\n          \"unique\": false,\n          \"of\": {\n            \"kind\": \"string\",\n            \"nullable\": false,\n            \"optional\": false,\n            \"unique\": false\n          }\n        },\n        \"title\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"upvoteCount\": {\n          \"kind\": \"number\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        }\n      },\n      \"indexes\": {\n        \"by_status\": {\n          \"fields\": [\n            \"status\"\n          ],\n          \"unique\": false\n        },\n        \"by_upvotes\": {\n          \"fields\": [\n            \"upvoteCount\"\n          ],\n          \"unique\": false\n        }\n      },\n      \"memory\": false,\n      \"relations\": {},\n      \"shardMode\": \"root\"\n    },\n    \"ratelimit_buckets\": {\n      \"commitOrdered\": false,\n      \"fields\": {\n        \"key\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"prev\": {\n          \"kind\": \"number\",\n          \"nullable\": false,\n          \"optional\": true,\n          \"unique\": false\n        },\n        \"ts\": {\n          \"kind\": \"number\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"value\": {\n          \"kind\": \"number\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        }\n      },\n      \"indexes\": {\n        \"by_key\": {\n          \"fields\": [\n            \"key\"\n          ],\n          \"unique\": false\n        }\n      },\n      \"memory\": false,\n      \"relations\": {},\n      \"shardMode\": \"root\"\n    },\n    \"summaries\": {\n      \"commitOrdered\": false,\n      \"fields\": {\n        \"feedbackIds\": {\n          \"kind\": \"array\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false,\n          \"of\": {\n            \"kind\": \"id\",\n            \"nullable\": false,\n            \"optional\": false,\n            \"unique\": false,\n            \"ref\": \"feedback\"\n          }\n        },\n        \"generatedAt\": {\n          \"kind\": \"number\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"summary\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"title\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        }\n      },\n      \"indexes\": {\n        \"by_generated\": {\n          \"fields\": [\n            \"generatedAt\"\n          ],\n          \"unique\": false\n        }\n      },\n      \"memory\": false,\n      \"relations\": {},\n      \"shardMode\": \"root\"\n    },\n    \"votes\": {\n      \"commitOrdered\": false,\n      \"fields\": {\n        \"feedbackId\": {\n          \"kind\": \"id\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false,\n          \"ref\": \"feedback\"\n        },\n        \"voterEmail\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        }\n      },\n      \"indexes\": {\n        \"by_feedback_and_voter\": {\n          \"fields\": [\n            \"feedbackId\",\n            \"voterEmail\"\n          ],\n          \"unique\": true\n        },\n        \"by_voter\": {\n          \"fields\": [\n            \"voterEmail\"\n          ],\n          \"unique\": false\n        }\n      },\n      \"memory\": false,\n      \"relations\": {},\n      \"shardMode\": \"root\"\n    }\n  },\n  \"version\": 1\n}\n" };
...
export const createShardDO = (config: ShardDOConfig = {}): new (state: ShardDOState, env: unknown) => ShardDOBase =>
    class extends ShardDOBase {
        ...
        private buildCtx(options: { bookmarks?: DispatchBookmark; functionPath?: string; headroom?: TransactionHeadroomTracker; identity?: SubscriptionIdentity; onRead?: (table: string, idOrScan?: string) => void; onReadRange?: (range: KeyRange) => void; scope?: QueryReadScope; trusted?: boolean } = {}): unknown {
            ...
            facade["feedback"] = bindTableFacade(db, "feedback");
            facade["votes"] = bindTableFacade(db, "votes");
            facade["comments"] = bindTableFacade(db, "comments");
            facade["summaries"] = bindTableFacade(db, "summaries");
