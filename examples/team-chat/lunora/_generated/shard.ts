...
const LUNORA_TABLE_INDEXES = JSON.parse("{\"profiles\":[{\"fields\":[\"userId\"],\"name\":\"by_user\",\"type\":\"index\",\"unique\":true}],\"channels\":[{\"fields\":[\"name\"],\"name\":\"by_name\",\"type\":\"index\",\"unique\":true}],\"messages\":[{\"fields\":[\"channelId\"],\"name\":\"by_channel\",\"type\":\"index\"},{\"fields\":[\"content\",\"channelId\"],\"name\":\"search_content\",\"type\":\"search\"}],\"presence\":[{\"fields\":[\"channelId\",\"sessionId\"],\"name\":\"by_channel_session\",\"type\":\"index\",\"unique\":true}],\"ratelimit_buckets\":[{\"fields\":[\"key\"],\"name\":\"by_key\",\"type\":\"index\"}]}") as Record<string, Array<{ fields: string[]; name: string; type: "geo" | "index" | "rank" | "search" | "vector"; unique?: boolean }>>;

/** Columns per table (typed, with PK/FK markers) for the studio's schema diagram, served via `__lunora_admin__:describeTable`. */
const LUNORA_TABLE_COLUMNS = JSON.parse("{\"profiles\":[{\"name\":\"_id\",\"optional\":false,\"pk\":true,\"type\":\"id\"},{\"name\":\"_creationTime\",\"optional\":false,\"type\":\"number\"},{\"name\":\"userId\",\"optional\":false,\"type\":\"string\"},{\"name\":\"name\",\"optional\":false,\"type\":\"string\"},{\"name\":\"avatarKey\",\"optional\":true,\"type\":\"string\"}],\"channels\":[{\"name\":\"_id\",\"optional\":false,\"pk\":true,\"type\":\"id\"},{\"name\":\"_creationTime\",\"optional\":false,\"type\":\"number\"},{\"name\":\"name\",\"optional\":false,\"type\":\"string\"},{\"name\":\"createdBy\",\"optional\":false,\"type\":\"string\"}],\"messages\":[{\"name\":\"_id\",\"optional\":false,\"pk\":true,\"type\":\"id\"},{\"name\":\"_creationTime\",\"optional\":false,\"type\":\"number\"},{\"name\":\"channelId\",\"optional\":false,\"type\":\"string\"},{\"name\":\"authorId\",\"optional\":false,\"type\":\"string\"},{\"name\":\"content\",\"optional\":false,\"type\":\"string\"},{\"name\":\"attachmentKey\",\"optional\":true,\"type\":\"string\"},{\"name\":\"attachmentName\",\"optional\":true,\"type\":\"string\"}],\"presence\":[{\"name\":\"_id\",\"optional\":false,\"pk\":true,\"type\":\"id\"},{\"name\":\"_creationTime\",\"optional\":false,\"type\":\"number\"},{\"name\":\"channelId\",\"optional\":false,\"type\":\"string\"},{\"name\":\"sessionId\",\"optional\":false,\"type\":\"string\"},{\"name\":\"userId\",\"optional\":false,\"type\":\"string\"},{\"name\":\"name\",\"optional\":false,\"type\":\"string\"},{\"name\":\"lastSeen\",\"optional\":false,\"type\":\"number\"}],\"ratelimit_buckets\":[{\"name\":\"_id\",\"optional\":false,\"pk\":true,\"type\":\"id\"},{\"name\":\"_creationTime\",\"optional\":false,\"type\":\"number\"},{\"name\":\"key\",\"optional\":false,\"type\":\"string\"},{\"name\":\"value\",\"optional\":false,\"type\":\"number\"},{\"name\":\"ts\",\"optional\":false,\"type\":\"number\"},{\"name\":\"prev\",\"optional\":true,\"type\":\"number\"}]}") as Record<
    string,
    Array<{
        bucket?: string;
        enumValues?: string[];
...
const LUNORA_ADVISORIES = JSON.parse("[{\"cacheKey\":\"table_without_insert:profiles\",\"categories\":[\"SCHEMA\"],\"description\":\"No function inserts into this table via `ctx.db.insert(\\\"<table>\\\", …)`. It may be read-only by design (seeded by a migration, replicated, or written through a path the advisor can't see) — or it may be dead schema.\",\"detail\":\"No function calls `ctx.db.insert(\\\"profiles\\\", …)` — table \\\"profiles\\\" has no discovered insert path.\",\"facing\":\"INTERNAL\",\"level\":\"INFO\",\"metadata\":{\"table\":\"profiles\"},\"name\":\"table_without_insert\",\"remediation\":\"If the table should be writable, add a mutation that calls `ctx.db.insert(\\\"<table>\\\", …)`. If it is read-only or seeded elsewhere, this advisory can be ignored.\",\"title\":\"Table has no insert path\"},{\"cacheKey\":\"nondeterministic_query_mutation:presence:52:Date.now\",\"categories\":[\"SCHEMA\"],\"description\":\"A `query`/`mutation` handler calls a non-deterministic API (`Date.now`, `Math.random`, `crypto.randomUUID`, `crypto.getRandomValues`, or `fetch`). A `query` may be re-run by a live subscription, so non-determinism there can flicker between evaluations (WARN). An ordinary `mutation` handler does not replay on this runtime — it runs at most once per logical write — so this is informational there (INFO) unless the mutation is itself invoked from a workflow step or queue consumer that can replay.\",\"detail\":\"`Date.now(…)` in heartbeat (presence:52) runs inside a mutation handler. Ordinary mutations don't replay on this runtime (idempotency dedup returns a cached result rather than re-running the handler, and an OCC conflict throws to the caller instead of retrying internally), so this is informational — no action needed unless `heartbeat` is invoked from a workflow step or queue consumer that can itself replay.\",\"facing\":\"INTERNAL\",\"level\":\"INFO\",\"metadata\":{\"callee\":\"Date.now\",\"exportName\":\"heartbeat\",\"file\":\"presence\",\"kind\":\"mutation\",\"line\":52},\"name\":\"nondeterministic_query_mutation\",\"remediation\":\"For a `query`: move the non-deterministic call into an `action(...)` (which runs once and may use ambient APIs), then pass the computed value into the mutation as an argument, or accept that the value may differ across re-evaluations. For an ordinary `mutation`: no action needed — the handler runs at most once per logical write on this runtime. If the mutation is dispatched from inside a workflow step or queue consumer, treat it like an action value instead, since the surrounding step/consumer can replay.\",\"title\":\"Non-deterministic call in query/mutation handler\"},{\"cacheKey\":\"nondeterministic_query_mutation:presence:58:Date.now\",\"categories\":[\"SCHEMA\"],\"description\":\"A `query`/`mutation` handler calls a non-deterministic API (`Date.now`, `Math.random`, `crypto.randomUUID`, `crypto.getRandomValues`, or `fetch`). A `query` may be re-run by a live subscription, so non-determinism there can flicker between evaluations (WARN). An ordinary `mutation` handler does not replay on this runtime — it runs at most once per logical write — so this is informational there (INFO) unless the mutation is itself invoked from a workflow step or queue consumer that can replay.\",\"detail\":\"`Date.now(…)` in heartbeat (presence:58) runs inside a mutation handler. Ordinary mutations don't replay on this runtime (idempotency dedup returns a cached result rather than re-running the handler, and an OCC conflict throws to the caller instead of retrying internally), so this is informational — no action needed unless `heartbeat` is invoked from a workflow step or queue consumer that can itself replay.\",\"facing\":\"INTERNAL\",\"level\":\"INFO\",\"metadata\":{\"callee\":\"Date.now\",\"exportName\":\"heartbeat\",\"file\":\"presence\",\"kind\":\"mutation\",\"line\":58},\"name\":\"nondeterministic_query_mutation\",\"remediation\":\"For a `query`: move the non-deterministic call into an `action(...)` (which runs once and may use ambient APIs), then pass the computed value into the mutation as an argument, or accept that the value may differ across re-evaluations. For an ordinary `mutation`: no action needed — the handler runs at most once per logical write on this runtime. If the mutation is dispatched from inside a workflow step or queue consumer, treat it like an action value instead, since the surrounding step/consumer can replay.\",\"title\":\"Non-deterministic call in query/mutation handler\"},{\"cacheKey\":\"procedure_without_structured_event:presence:leave\",\"categories\":[\"SCHEMA\"],\"description\":\"A public `mutation`/`action` emits no structured event. When it fails you get a stack trace with no request context — no ids, no tenant, no outcome — so the failure is visible but not searchable.\",\"detail\":\"Public mutation `leave` (presence) emits no structured event. Add a `ctx.log` line or a `ctx.span` so a failure carries its request context.\",\"facing\":\"INTERNAL\",\"level\":\"INFO\",\"metadata\":{\"exportName\":\"leave\",\"file\":\"presence\",\"kind\":\"mutation\"},\"name\":\"procedure_without_structured_event\",\"remediation\":\"Emit one event on the primary path: `ctx.log.info(\\\"<verb>\\\", { … })`, or wrap the handler in `ctx.span(\\\"<name>\\\", …)` to attach timing too.\",\"title\":\"Public write emits no structured event\"}]") as AdvisoryFinding[];
...
const LUNORA_ADVISOR_PROCEDURES = JSON.parse("[{\"callsMail\":false,\"emitsEvent\":false,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":false,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"list\",\"file\":\"channels\",\"hasEmailArg\":false,\"kind\":\"query\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":true,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"create\",\"file\":\"channels\",\"hasEmailArg\":false,\"kind\":\"mutation\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":false,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":false,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"list\",\"file\":\"messages\",\"hasEmailArg\":false,\"kind\":\"query\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":false,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":false,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"search\",\"file\":\"messages\",\"hasEmailArg\":false,\"kind\":\"query\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":true,\"fanOut\":false,\"handlesErrors\":true,\"reachesOutbound\":true,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"attachmentUrl\",\"file\":\"messages\",\"hasEmailArg\":false,\"kind\":\"action\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":true,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"send\",\"file\":\"messages\",\"hasEmailArg\":false,\"kind\":\"mutation\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":true,\"fanOut\":false,\"handlesErrors\":true,\"reachesOutbound\":true,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"requestAttachmentUpload\",\"file\":\"messages\",\"hasEmailArg\":false,\"kind\":\"action\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":false,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":false,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"list\",\"file\":\"presence\",\"hasEmailArg\":false,\"kind\":\"query\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":true,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"heartbeat\",\"file\":\"presence\",\"hasEmailArg\":false,\"kind\":\"mutation\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":false,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"leave\",\"file\":\"presence\",\"hasEmailArg\":false,\"kind\":\"mutation\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":false,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":false,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"list\",\"file\":\"profiles\",\"hasEmailArg\":false,\"kind\":\"query\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":true,\"fanOut\":false,\"handlesErrors\":true,\"reachesOutbound\":true,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"avatarUrl\",\"file\":\"profiles\",\"hasEmailArg\":false,\"kind\":\"action\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":true,\"fanOut\":false,\"handlesErrors\":false,\"reachesOutbound\":false,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"save\",\"file\":\"profiles\",\"hasEmailArg\":false,\"kind\":\"mutation\",\"visibility\":\"public\"},{\"callsMail\":false,\"emitsEvent\":true,\"fanOut\":false,\"handlesErrors\":true,\"reachesOutbound\":true,\"runsAiGeneration\":false,\"throwsBareError\":false,\"unboundedAiGeneration\":false,\"usesInsertManyUnsafe\":false,\"writesUserTable\":false,\"exempt\":false,\"exemptReason\":\"\",\"usesCaptcha\":false,\"usesEmailGate\":false,\"usesMask\":false,\"usesRateLimit\":true,\"usesRls\":false,\"analyzableBody\":true,\"exportName\":\"requestAvatarUpload\",\"file\":\"profiles\",\"hasEmailArg\":false,\"kind\":\"action\",\"visibility\":\"public\"}]") as AdvisorProcedure[];
...
const LUNORA_STUDIO_FEATURES = JSON.parse("{\"analytics\":false,\"auth\":true,\"containers\":false,\"flags\":false,\"kv\":false,\"mail\":false,\"notifications\":false,\"payments\":false,\"queues\":false,\"scheduler\":false,\"storage\":true,\"vectors\":false,\"workflows\":false,\"platform\":{\"features\":{\"shardedState\":\"native\",\"globalTables\":\"native\",\"websocketHibernation\":\"native\",\"durableStreams\":\"emulated\",\"commitOrderedTables\":\"native\",\"localSql\":\"native\",\"serverReactors\":\"emulated\",\"memoryTables\":\"emulated\",\"shardAlarms\":\"native\",\"shardPlacement\":\"native\",\"shardReadReplicas\":\"emulated\",\"crossShardFanout\":\"emulated\",\"queues\":\"native\",\"relationGraph\":\"emulated\",\"workflows\":\"native\",\"scheduler\":\"emulated\",\"cronTriggers\":\"native\",\"authJurisdictionMove\":\"native\",\"agents\":\"emulated\",\"objectStorage\":\"native\",\"objectStorageBackups\":\"emulated\",\"objectStorageCdcArchive\":\"emulated\",\"keyValueStore\":\"native\",\"vectorStore\":\"native\",\"ai\":\"native\",\"browser\":\"native\",\"images\":\"native\",\"containers\":\"native\",\"analytics\":\"native\",\"edgeRequestMetadata\":\"native\",\"hostTraceFusion\":\"native\",\"logArchive\":\"native\",\"pipelines\":\"native\",\"pointInTimeRecovery\":\"native\",\"mail\":\"emulated\",\"secrets\":\"native\",\"hyperdrive\":\"native\",\"httpCache\":\"native\",\"identityProxy\":\"native\"},\"id\":\"cloudflare\",\"name\":\"Cloudflare\"}}") as StudioFeaturesResult;
...
const LUNORA_SCHEMA_SNAPSHOT: { hash: string; json: string } = { hash: "f7d88d1bf36b225d", json: "{\n  \"migrationIds\": [],\n  \"tables\": {\n    \"channels\": {\n      \"commitOrdered\": false,\n      \"fields\": {\n        \"createdBy\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"name\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        }\n      },\n      \"indexes\": {\n        \"by_name\": {\n          \"fields\": [\n            \"name\"\n          ],\n          \"unique\": true\n        }\n      },\n      \"memory\": false,\n      \"relations\": {},\n      \"shardMode\": \"root\"\n    },\n    \"messages\": {\n      \"commitOrdered\": false,\n      \"fields\": {\n        \"attachmentKey\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": true,\n          \"unique\": false\n        },\n        \"attachmentName\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": true,\n          \"unique\": false\n        },\n        \"authorId\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"channelId\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"content\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        }\n      },\n      \"indexes\": {\n        \"by_channel\": {\n          \"fields\": [\n            \"channelId\"\n          ],\n          \"unique\": false\n        }\n      },\n      \"memory\": false,\n      \"relations\": {},\n      \"shardMode\": \"shardBy:channelId\"\n    },\n    \"presence\": {\n      \"commitOrdered\": false,\n      \"fields\": {\n        \"channelId\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"lastSeen\": {\n          \"kind\": \"number\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"name\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"sessionId\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"userId\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        }\n      },\n      \"indexes\": {\n        \"by_channel_session\": {\n          \"fields\": [\n            \"channelId\",\n            \"sessionId\"\n          ],\n          \"unique\": true\n        }\n      },\n      \"memory\": false,\n      \"relations\": {},\n      \"shardMode\": \"shardBy:channelId\"\n    },\n    \"profiles\": {\n      \"commitOrdered\": false,\n      \"fields\": {\n        \"avatarKey\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": true,\n          \"unique\": false\n        },\n        \"name\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"userId\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        }\n      },\n      \"indexes\": {\n        \"by_user\": {\n          \"fields\": [\n            \"userId\"\n          ],\n          \"unique\": true\n        }\n      },\n      \"memory\": false,\n      \"relations\": {},\n      \"shardMode\": \"global:d1\"\n    },\n    \"ratelimit_buckets\": {\n      \"commitOrdered\": false,\n      \"fields\": {\n        \"key\": {\n          \"kind\": \"string\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"prev\": {\n          \"kind\": \"number\",\n          \"nullable\": false,\n          \"optional\": true,\n          \"unique\": false\n        },\n        \"ts\": {\n          \"kind\": \"number\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        },\n        \"value\": {\n          \"kind\": \"number\",\n          \"nullable\": false,\n          \"optional\": false,\n          \"unique\": false\n        }\n      },\n      \"indexes\": {\n        \"by_key\": {\n          \"fields\": [\n            \"key\"\n          ],\n          \"unique\": false\n        }\n      },\n      \"memory\": false,\n      \"relations\": {},\n      \"shardMode\": \"root\"\n    }\n  },\n  \"version\": 1\n}\n" };
