...
if (source["authorName"].length > 256) return DEFER;
...
export interface Caller {
    messages: {
        list: (args?: {}) => Promise<{ _id: Id<"messages">; authorName: string; createdAt: number; text: string; userId: string }[]>;
        send: (args: { authorName: string; text: string }) => Promise<Id<"messages">>;
    };
}
