...
import * as lunora_tasks_0 from "../tasks.js";
...
export const LUNORA_FUNCTIONS: Record<string, RegisteredLunoraFunction> = {
    "tasks:create": lunora_tasks_0.create as unknown as RegisteredLunoraFunction,
    "tasks:list": lunora_tasks_0.list as unknown as RegisteredLunoraFunction,
    "tasks:move": lunora_tasks_0.move as unknown as RegisteredLunoraFunction,
    "tasks:remove": lunora_tasks_0.remove as unknown as RegisteredLunoraFunction,
    "tasks:rename": lunora_tasks_0.rename as unknown as RegisteredLunoraFunction,
};
 ...
 */
installCompiledValidatorMap(lunora_tasks_0.remove.args, (source) => {
if (typeof source !== "object" || source === null || Array.isArray(source)) return DEFER;
if (Object.getPrototypeOf(source) !== Object.prototype && Object.getPrototypeOf(source) !== null) return DEFER;
if (typeof source["id"] !== "string") return DEFER;
return { "id": source["id"] };
});
installCompiledValidatorMap(lunora_tasks_0.rename.args, (source) => {
if (typeof source !== "object" || source === null || Array.isArray(source)) return DEFER;
if (Object.getPrototypeOf(source) !== Object.prototype && Object.getPrototypeOf(source) !== null) return DEFER;
if (typeof source["id"] !== "string") return DEFER;
...
export interface Caller {
    tasks: {
        create: (args: { title: string; status?: "todo" | "in-progress" | "done" | "archived" }) => Promise<Id<"tasks">>;
        list: (args?: {}) => Promise<import("./dataModel.js").Doc_tasks[]>;
        move: (args: { id: Id<"tasks">; status: "todo" | "in-progress" | "done" | "archived"; index: number }) => Promise<void>;
        remove: (args: { id: Id<"tasks"> }) => Promise<void>;
        rename: (args: { id: Id<"tasks">; title: string }) => Promise<void>;
    };
}
...
export const createCaller = (context: CallerCtx): Caller => ({
    tasks: {
        create: (args) => callRegistered(context, "tasks:create", args),
        list: (args) => callRegistered(context, "tasks:list", args),
        move: (args) => callRegistered(context, "tasks:move", args),
        remove: (args) => callRegistered(context, "tasks:remove", args),
        rename: (args) => callRegistered(context, "tasks:rename", args),
    },
});
