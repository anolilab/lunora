...
export const limits = {
    ...
    // A broadcast pushes caller-supplied content to EVERY registered device.
    // With no sign-in on this demo, that is the abuse path worth spending the
    // tightest bucket on.
    broadcast: { kind: "fixed window", period: 60_000, rate: 3 },
