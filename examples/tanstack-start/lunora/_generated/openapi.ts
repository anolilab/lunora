...
export const openApiSpec: Record<string, unknown> = {
    ...
    "openapi": "3.1.0",
    "paths": {
        "/_lunora/rpc#messages:board": {
            "post": {
                "description": "Invoke the `query` `messages:board` over the Lunora RPC envelope (POST /_lunora/rpc).",
                "operationId": "messages:board",
                "requestBody": {
                    "content": {
                        "application/json": {
                            "schema": {
