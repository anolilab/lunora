...
export const openApiSpec: Record<string, unknown> = {
    ...
    "openapi": "3.1.0",
    "paths": {
        "/_lunora/rpc#billing:apiCallsRemaining": {
            "post": {
                "description": "Invoke the `action` `billing:apiCallsRemaining` over the Lunora RPC envelope (POST /_lunora/rpc).",
        ...
        "/_lunora/rpc#billing:mySubscriptions": {
            "post": {
                "description": "Invoke the `query` `billing:mySubscriptions` over the Lunora RPC envelope (POST /_lunora/rpc).",
        ...
        "/_lunora/rpc#billing:recordApiCall": {
            "post": {
                "description": "Invoke the `action` `billing:recordApiCall` over the Lunora RPC envelope (POST /_lunora/rpc).",
