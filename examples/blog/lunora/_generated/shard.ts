...
const LUNORA_STUDIO_FEATURES = JSON.parse("{\"platform\":{\"id\":\"cloudflare\",\"name\":\"Cloudflare\",\"unsupported\":[]},\"analytics\":true,\"auth\":true,\"containers\":false,\"flags\":false,\"kv\":true,\"mail\":false,\"notifications\":false,\"payments\":false,\"queues\":false,\"scheduler\":true,\"storage\":true,\"vectors\":true,\"workflows\":false}") as StudioFeaturesResult;
