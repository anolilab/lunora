...
import type { AggregateOptions, GroupByOptions, DatabaseWriterLike, DataMigrationLike, MigrationRunResult, QueryArgs, RankOptions, RankPageOptions, RestrictableQueryOptions, RunShardApplyCdcArgs, RunShardMigrationArgs, RunShardRankBeforeArgs, RunShardWriteArgs, RunShardWriteResult, SchedulerLike, SchemaLike, ShardDOState, SqlExec, WhereInput, WriteHook } from "@cirrus/do";
...
export const createShardDO = (config: ShardDOConfig = {}): new (state: ShardDOState, env: unknown) => ShardDOBase =>
    class extends ShardDOBase {
        ...
        private buildCtx(options: { onRead?: (table: string) => void } = {}): unknown {
            ...
            facade["posts"] = bindTable(db, "posts");
            facade["drafts"] = bindTable(db, "drafts");
