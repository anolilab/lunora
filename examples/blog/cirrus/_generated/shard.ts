...
import type { AdvisoryFinding, DatabaseWriterLike, DataMigrationLike, LogSink, MigrationRunResult, RunShardApplyCdcArgs, RunShardMigrationArgs, RunShardRankBeforeArgs, RunShardWriteArgs, RunShardWriteResult, SchedulerLike, SchemaLike, ShardDOState, SqlExec, SystemReaderStorageLike, WriteHook } from "@cirrus/do";
...
const CIRRUS_ADVISORIES: AdvisoryFinding[] = [
    ...
    {
        "cacheKey": "filter_without_index:cleanup:17:drafts",
        "categories": [
            "PERFORMANCE"
        ],
        ...
        "detail": "Query on \"drafts\" at cleanup:17 calls .filter() without an index — it loads every row of \"drafts\" and filters in memory.",
        "facing": "EXTERNAL",
        "level": "WARN",
        "metadata": {
            "file": "cleanup",
