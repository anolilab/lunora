...
const LUNORA_ADVISORIES: AdvisoryFinding[] = [
    ...
    {
        "cacheKey": "unbounded_string_arg:todos:add:text",
        "categories": [
            "SECURITY"
        ],
        ...
        "detail": "Arg `text` of public procedure `add` (todos:21) is an unbounded `v.string()`. Add a max-length bound to cap payload size.",
        "facing": "EXTERNAL",
        "level": "INFO",
        "metadata": {
            "argument": "text",
    ...
    },
    {
        ...
        "detail": "Public mutation `add` (todos) emits no structured event. Add a `ctx.log` line or a `ctx.span` so a failure carries its request context.",
        "facing": "INTERNAL",
        "level": "INFO",
        "metadata": {
            "exportName": "add",
    ...
    {
        "cacheKey": "procedure_without_structured_event:todos:toggle",
        "categories": [
            "SCHEMA"
        ],
        "description": "A public `mutation`/`action` emits no structured event. When it fails you get a stack trace with no request context — no ids, no tenant, no outcome — so the failure is visible but not searchable.",
        "detail": "Public mutation `toggle` (todos) emits no structured event. Add a `ctx.log` line or a `ctx.span` so a failure carries its request context.",
        "facing": "INTERNAL",
        "level": "INFO",
        "metadata": {
            "exportName": "toggle",
    ...
    {
        "cacheKey": "procedure_without_structured_event:todos:remove",
        "categories": [
            "SCHEMA"
        ],
        "description": "A public `mutation`/`action` emits no structured event. When it fails you get a stack trace with no request context — no ids, no tenant, no outcome — so the failure is visible but not searchable.",
        "detail": "Public mutation `remove` (todos) emits no structured event. Add a `ctx.log` line or a `ctx.span` so a failure carries its request context.",
        "facing": "INTERNAL",
        "level": "INFO",
        "metadata": {
            "exportName": "remove",
...
const LUNORA_SCHEMA_SNAPSHOT: { hash: string; json: string } = { hash: "5a661add7981184f", json: "{\n  \"migrationIds\": [],\n  \"tables\": {\n    \"todos\": {\n      \"fields\": {\n        \"text\": {\n          \"kind\": \"string\",\n          \"optional\": false\n        },\n        \"done\": {\n          \"kind\": \"boolean\",\n          \"optional\": false\n        },\n        \"createdAt\": {\n          \"kind\": \"number\",\n          \"optional\": false\n        }\n      },\n      \"indexes\": {\n        \"by_creation\": {\n          \"fields\": [\n            \"createdAt\"\n          ],\n          \"unique\": false\n        }\n      },\n      \"relations\": {},\n      \"shardMode\": \"root\"\n    }\n  },\n  \"version\": 1\n}\n" };
