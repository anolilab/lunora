...
> templates and adapters exist, but the hook-injection and single-bundle deploy
> have not been run end-to-end in production. Treat the class-B steps above as the
