...
would clobber the wrangler `main` field — unlike SvelteKit, whose adapter
...
- [@lunora/runtime](/docs/packages/runtime) — `withFrameworkWorker`, the composition primitive `withLunora` aliases
