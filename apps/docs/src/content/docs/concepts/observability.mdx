...
| ---------------- | ------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| `notify.send`    | `channel`, `provider`, `status` | one per attempted send. `status` is `accepted` (the provider took it), `failed`, or `gone` (the endpoint is unregistered and was pruned).           |
