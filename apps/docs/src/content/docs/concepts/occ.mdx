...
The practical consequence: **a mutation is a transaction.** Read, decide, write —
the values you read cannot change underneath you mid-handler, and either every
...
above is safe because nothing else writes while it runs.
