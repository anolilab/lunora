...
the OCC guard means they fail loudly rather than silently clobbering.
...
a concurrent mutation can commit.
...
that constraint is what should drive your choice of shard key. When
