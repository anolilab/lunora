...
<Callout type="info">
The Python SDK is a v1 proof that the model ports cleanly. Optimistic updates,
the offline queue, and codegen'd typed bindings are follow-ups (see the plan's
Phase 2) rather than part of this first release.
</Callout>
