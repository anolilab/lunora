...
[package reference](/docs/packages/bindings#standalone--definevectorindexoptions)
for the full shape.
...
- [@lunora/bindings/vectors](/docs/packages/bindings) — full adapter reference (standalone indexes, sync internals, Studio panel)
