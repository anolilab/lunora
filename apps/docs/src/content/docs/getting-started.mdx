...
- **Node** `^22.15.0 || >=24.11.0` — the range every published Lunora package declares in `engines`.
- **A package manager** — pnpm `>=10.32.1`, or npm, yarn, or bun. The scaffolded app pins none of them; the tabs below cover all four.
