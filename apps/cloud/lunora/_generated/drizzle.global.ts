...
export const observations = sqliteTable("observations", {
    ...
    evaluations: text("evaluations", { mode: "json" }).$type<Array<{ label?: string; name: string; score: number }>>(),
    functionPath: text("functionPath"),
    input: text("input"),
...
export const alertRules = sqliteTable("alertRules", {
    _id: text("_id").primaryKey(),
    _creationTime: integer("_creationTime").notNull(),
    baselineWindows: real("baselineWindows"),
...
export const paymentSessions = sqliteTable("paymentSessions", {
    _id: text("_id").primaryKey(),
    _creationTime: integer("_creationTime").notNull(),
    amountMinor: real("amountMinor").notNull(),
    capturedMinor: real("capturedMinor").notNull(),
    createdAt: real("createdAt").notNull(),
    currency: text("currency").notNull(),
    provider: text("provider").notNull(),
    providerSessionId: text("providerSessionId").notNull(),
    referenceId: text("referenceId").notNull(),
    refundedMinor: real("refundedMinor").notNull(),
