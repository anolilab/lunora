# Extracting `@lunora/cloud` into a private repo

The control plane is the proprietary product layer and is
...
imports **only published `@lunora/*` package entry points** (verified — no deep
...
| ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `"@lunora/*": "workspace:*"` deps                                       | published versions, e.g. `"@lunora/server": "^0.1"` (from npm / the private registry)                                                                   |
