...
type Build = ReturnOf<typeof api.builds.listByProject>[number];
type BuildId = Build["_id"];
 ...
 *
 * Four derivations that only make sense together, lifted out of the component so
 * its body reads as layout: the selected deployment (falling back to the newest
