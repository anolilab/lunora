...
/** Built once: `Intl.NumberFormat` compiles its locale data on construction, and this renders every quota row of every plan card. */
const COMPACT_FORMAT = new Intl.NumberFormat("en", { notation: "compact" });

const compact = (value: number): string => COMPACT_FORMAT.format(value);
