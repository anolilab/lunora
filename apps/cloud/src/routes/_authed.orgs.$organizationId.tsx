...
import { identifyOperator } from "../client/analytics";
...
const OrganizationLayout = (): ReactElement => {
    ...
    // Attach the operator to product events. In an effect, not in render: it
    // writes to the PostHog client, and it must not run during SSR — the
