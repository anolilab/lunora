...
- **Node.js** `^22.14.0 || >=24.10.0` (see [`.nvmrc`](../.nvmrc); `nvm use` works).
- **pnpm** `10.32.1` exactly. Enable corepack (`corepack enable`) and it picks up the version pinned in [`package.json`](../package.json).
