# Cirrus Studio ↔ Cloudflare Dashboard — Boundary & Strategy

> Written 2026-06-06. Decides what the cirrus studio should own, where it should
> beat Cloudflare's own studio, and the few places it should hand off. Grounded in
> the current studio surface (`packages/studio/src/*`) and the cirrus runtime
> (`@cirrus/do`, `@cirrus/runtime`, `@cirrus/scheduler`, `@cirrus/storage`).

## The principle

**Cloudflare's studio is infra-level and domain-blind. Cirrus sits _in the request
...
| Studio area                                   | CF coverage                                                         | Verdict                                | Why                                                                                                                                                                                          |
| --------------------------------------------- | ------------------------------------------------------------------- | -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
