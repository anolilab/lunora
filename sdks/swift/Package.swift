...
let package = Package(
    ...
    targets: [
        .target(name: "Lunora"),
        // Compile-only: proves the generated surface still builds against the
        // runtime, a coupling the target contract deliberately keeps out of
        // itself. Regenerated by CI; the committed copy is a sample.
