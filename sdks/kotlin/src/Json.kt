...
object Key {
    ...
    fun formatNumber(value: Double): String {
        ...
        // Negative zero keeps its sign in a key — `stableStringify` emits the
        // bare token "-0" — and every integer conversion below drops it.
        if (value == 0.0 && 1.0 / value < 0.0) return "-0"
