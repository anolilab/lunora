...
itself, while 312 is the price its fix paid and is the only one still open. 312
needs its §4 decision made with a measurement before anyone writes code.
