...
| Plan | Title                                                               | Category  | Pkg                 | Pri | Effort | Risk | Status                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---- | ------------------------------------------------------------------- | --------- | ------------------- | --- | ------ | ---- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 300  | Decode wire-tagged doc columns on the three display read paths      | bug       | studio/shard-engine | P3  | S      | LOW  | TODO — depends on 265's branch for `decodeDocJson`; branch from it                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
