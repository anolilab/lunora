...
| Plan | Title                                            | Category  | Pri | Effort | Risk     | Status                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---- | ------------------------------------------------ | --------- | --- | ------ | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 134  | `@lunora/x402` — agentic payments (charge + pay) | direction | P2  | L      | MED–HIGH | IN PROGRESS — Phases 0/1/2/4/5/6 shipped on `feat/x402-agentic-payments`. **Charge rail**: HTTP-action `withX402` (Phase 1, `3ab9af42d`) + per-procedure `.x402({ price })` with a fail-closed origin-worker 402 seam on `/_lunora/rpc` (Phase 2: 2a `dbcd94a84`, 2b `ab3a10d3`) + settlement receipts & opt-in one-way reporting bridge (Phase 6, `34b29c24`). **Pay rail**: EVM raw-key signer (Phase 4, `8ed00cf2e`) + security-critical spend policy (Phase 5, `8ed00cf2e`). Reuses `@x402/core` + `@x402/evm` (+ `@x402/fetch`), all Apache-2.0. **Remaining**: Phase 3 (paid MCP tools) gated on a remote MCP-over-HTTP transport (`@lunora/mcp` is stdio-only); optional codegen/config DX wiring (`ctx.x402` charge/pay helpers, `@lunora/config` recipient-var + facilitator-URL validation + `.dev.vars` wallet-secret scaffolder). CDP + SVM pay custody deferred, failing loudly with `NOT_IMPLEMENTED`. See [134-x402-agentic-payments.md](134-x402-agentic-payments.md) |
